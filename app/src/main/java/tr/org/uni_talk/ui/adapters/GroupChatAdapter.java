...
/**
 * Created by sadik on 8/25/16.
 */
public class GroupChatAdapter extends ArrayAdapter<Contact>  {
    ...
    public GroupChatAdapter(Context context, int resource,List<Contact> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(contact != null){
            ...
            if(username != null && userStatus != null){
                ...
                userStatus.setText(contact.getStatus());
            }
        }
